...
const Header = ({ adminUser, VITE_API_URL, onLogout, ocultarLandingNav = false }) => {
      ...
      <nav className="nav-bar">
        <div className="logo-section">
          ...
          {adminUser?.organization_logo && (
            <img
              src={`https://aura-back-3h9b.onrender.com/${adminUser.organization_logo}`}
              alt="Logo"
              height="30"
